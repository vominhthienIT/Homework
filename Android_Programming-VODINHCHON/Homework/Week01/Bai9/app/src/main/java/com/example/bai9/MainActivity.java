...
public class MainActivity extends AppCompatActivity {
    ...
    public void eventPlayer1(){
        //Su kien nguoi choi 1
        btnrut1.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void newGame(){
        btnrut1.setEnabled(true);
        btnrut2.setEnabled(false);
        btnchoilai.setEnabled(true);
        btnbatdau.setEnabled(false);
        Toast.makeText(getApplicationContext(), "BẮT ĐẦU ! NGƯỜI CHƠI 1 LẬT BÀI TRƯỚC.", Toast.LENGTH_SHORT).show();
    }
...
//Xu ly diem nc2
    ...
    public void whoIsWon(){
        ...
        if(diemnc1 == -1 && diemnc2 == -1){
            ...
            Toast.makeText(getApplicationContext(), "NGƯỜI CHƠI 1 CHIẾN THẮNG !", Toast.LENGTH_SHORT).show();
            endGame();
        }
        else if(diemnc1 != -1 && diemnc2 == -1){
            Toast.makeText(getApplicationContext(), "NGƯỜI CHƠI 2 CHIẾN THẮNG !", Toast.LENGTH_SHORT).show();
            endGame();
        }
